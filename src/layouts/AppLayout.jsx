...
export default function AppLayout({ children }) {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950 flex">
      ...
      {/* Sidebar */}
      <aside
        className={`fixed lg:static inset-y-0 left-0 z-50 w-64 bg-navy transform transition-transform duration-300 lg:transform-none ${
      ...
      <div className="flex-1 flex flex-col min-h-screen">
        {/* Top Bar */}
        <header className="bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-800 px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between">
          <button
